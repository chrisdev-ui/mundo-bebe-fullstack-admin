  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "flex items-center gap-2 text-sm font-medium capitalize",
        ...
        day_selected:
          "bg-accent text-accent-foreground hover:bg-primary hover:text-white focus:bg-primary focus:text-white",
