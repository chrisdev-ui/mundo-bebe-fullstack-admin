...
interface ColorsFloatingBarProps {
  table: Table<Color>;
}

export function ColorsFloatingBar({ table }: ColorsFloatingBarProps) {
  const rows = table.getFilteredSelectedRowModel().rows;

  const [isPending, startTransition] = useTransition();
  const { mutate: deleteColors, isPending: isDeletePending } =
    useDeleteColors();
