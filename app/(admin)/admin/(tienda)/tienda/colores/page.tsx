...
export default async function ManageColors(props: ManageColorsProps) {
    ...
    <PageContainer>
      <div className="space-y-4">
        <AdminPageHeader
          ...
          description="Aquí podrás gestionar todos los colores de tu tienda."
        />
        <Separator />
