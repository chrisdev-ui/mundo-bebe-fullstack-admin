...
interface DesignsFloatingBarProps {
  table: Table<Design>;
}

export function DesignsFloatingBar({ table }: DesignsFloatingBarProps) {
  const rows = table.getFilteredSelectedRowModel().rows;

  const [isPending, startTransition] = useTransition();
  const { mutate: deleteDesigns, isPending: isDeletePending } =
    useDeleteDesigns();
