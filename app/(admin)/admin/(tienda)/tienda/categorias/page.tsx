...
export default async function ManageCategories(props: ManageCategoriesProps) {
    ...
    <PageContainer>
      <div className="space-y-4">
        <AdminPageHeader
          ...
          description="Aquí podrás gestionar todas las categorías de tu tienda."
        />
        <Separator />
        <FeatureFlagsProvider>
          ...
          >
            <CategoriesTable promises={promises} />
          </Suspense>
        </FeatureFlagsProvider>
      </div>
    </PageContainer>
