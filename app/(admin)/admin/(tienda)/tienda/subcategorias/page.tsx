...
export default async function ManageSubcategories(
  props: ManageSubcategoriesProps,
) {
    ...
    <PageContainer>
      <div className="space-y-4">
        <AdminPageHeader
          ...
          description="Aquí podrás gestionar todas las subcategorías de tu tienda."
        />
        <Separator />
        <FeatureFlagsProvider>
          ...
          >
            <SubcategoriesTable promises={promises} />
          </Suspense>
        </FeatureFlagsProvider>
      </div>
    </PageContainer>
