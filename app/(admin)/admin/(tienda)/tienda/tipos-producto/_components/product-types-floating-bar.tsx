...
interface ProductTypesFloatingBarProps {
  table: Table<ProductType>;
}

export function ProductTypesFloatingBar({ table }: ProductTypesFloatingBarProps) {
  const rows = table.getFilteredSelectedRowModel().rows;

  const [isPending, startTransition] = useTransition();
  const { mutate: deleteProductTypes, isPending: isDeletePending } =
            ...
            <div className="flex items-center gap-1.5">
              <Tooltip>
                ...
                <TooltipContent className="border bg-accent font-semibold text-foreground dark:bg-zinc-900">
                  <p>Exportar tipos de producto</p>
                </TooltipContent>
              </Tooltip>
              <Tooltip>
                <TooltipTrigger asChild>
                ...
                <TooltipContent className="border bg-accent font-semibold text-foreground dark:bg-zinc-900">
                  <p>Eliminar tipos de producto</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
